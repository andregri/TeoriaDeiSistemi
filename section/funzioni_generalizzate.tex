...
\begin{document}
	\section{Gradino}
		\begin{figure}[h!]
			...
			\end{subfigure}
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=5cm, height=3cm]{2.funzioni_generalizzate/gradino}
			\end{subfigure}
		\end{figure}
	...
	\section{Rampa}
		\begin{figure}[h!]
			...
			\end{subfigure}
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=5cm, height=3cm]{2.funzioni_generalizzate/rampa}
			\end{subfigure}
		\end{figure}
	...
	\section{Parabola}
		\begin{figure}[h!]
			...
			\end{subfigure}
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=5cm, height=3cm]{2.funzioni_generalizzate/parabola}
			\end{subfigure}
		\end{figure}
	...
	\section{Impulso}
		...
		\begin{figure}[h!]
			...
			\end{subfigure}
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=5cm, height=3cm]{2.funzioni_generalizzate/impulso}
			\end{subfigure}
		\end{figure}
		%
		\linebreak
	...
	\section{Doppietto}
		...
		\begin{figure}[h!]
			...
			\end{subfigure}
			\begin{subfigure}{0.4\textwidth}
				\includegraphics[width=5cm, height=3cm]{2.funzioni_generalizzate/doppietto}
			\end{subfigure}
		\end{figure}
		\newpage
	...
	\begin{Exercise}[title={Derivata di una funzione definita a tratti}, difficulty=3]
		...
		\begin{figure}[h!]
			\centering
			\resizebox{.7\columnwidth}{!}{\input{img/2.funzioni_generalizzate/esercizi/derivata_funzione_def_tratti}}
