...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{plot/risposta_gradino/sistema_ord_2_w_cost}
		\caption{Grafico della risposta forzata nel tempo al variare di $ \xi $, con $ w_0 $ fissato.}
	\end{figure} 
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{plot/risposta_gradino/sistema_ord_2_xi_cost}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{plot/risposta_gradino/parametri}
	\end{figure}
	%
