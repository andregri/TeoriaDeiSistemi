...
\begin{document}
	...
	\section{Sistemi serie/parallelo}
		...
		\paragraph{Parallelo}
			...
			\]
			\begin{figure}[h!]
				\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/dimostrazione_parallelo}
			\end{figure}
	...
	\subsection{Propriet\'a di controllabilit\'a e osservabilit\'a}
		...
		\begin{figure}[h!]
			\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/sistema_ausiliario}
		...
		\paragraph{Esempio}
			...
			\begin{figure}[h!]
				\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/esempio_sistema_ausiliario2}
			\end{figure}
			\begin{itemize}
				\item 
	...
	\section{Effetto cancellazione}
		\begin{figure}[h!]
			\centering\includegraphics[width=.4\textwidth]{sistemi_interconnessi/effetto_cancellazione1}
		...
		\begin{figure}[h!]
			\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/effetto_cancellazione2}
		...
		\begin{figure}[h!]
			\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/effetto_cancellazione3}
	...
	\subsection{Dove "finiscono" gli autovalori "cancellati"}
		...
		\begin{figure}[h!]
			\centering\includegraphics[width=.7\textwidth]{sistemi_interconnessi/effetto_cancellazione4}
		\end{figure}
