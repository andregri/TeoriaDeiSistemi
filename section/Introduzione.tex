...
\begin{document}
	...
	\subsection{Amplificatore ideale lineare}
		\begin{wrapfigure}{r}{0.5\linewidth}%
			\vspace{-40pt}
			\includegraphics[width=\linewidth]{1.introduzione/amplificatore}
		\end{wrapfigure}
	...
	\subsection{Circuito RC} 
		...
		\begin{figure}[h!]
			...
			\begin{subfigure}{0.48\linewidth}
				\vspace{-2cm}
				\includegraphics[width=\linewidth]{1.introduzione/rc_plot}
	...
	\section{Variabili di un sistema}
			\begin{figure}[h!]
				\centering
				\includegraphics[width=.3\textwidth]{1.introduzione/sistema}
			\end{figure}
			\begin{itemize}
	...
	\subsection{Massa-molla}
		...
		\begin{figure}[h!]
			...
			\begin{subfigure}[b]{0.4\linewidth}
				\includegraphics[width=.8\linewidth]{1.introduzione/massa_molla}
	...
	\subsection{Vasca}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.3\textwidth]{1.introduzione/vasca}
		\end{figure}
