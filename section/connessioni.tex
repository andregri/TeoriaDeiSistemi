...
\begin{document}
	...
	\section{Connessioni equivalenti}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq1}
			\caption{Spostamento diramazione a monte di un blocco}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq2}
			\caption{Spostamento diramazione a valle di un blocco}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq3}
			\caption{Spostamento nodo sommatore a valle di un blocco}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq4}
			\caption{Spostamento nodo sommatore a monte di un blocco}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq5}
			\caption{Accumulo e scambio di nodi sommatori}
		\end{figure}
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{interconnections/connessione_eq6}
